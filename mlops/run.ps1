...
$convert_port = ((docker port $convert_id) -match "0.0.0.0").Split(":")[1]
...
$predict_port = ((docker port $predict_id) -match "0.0.0.0").Split(":")[1]
...
$webapp_port = ((docker port $webapp_id) -match "0.0.0.0").Split(":")[1]
